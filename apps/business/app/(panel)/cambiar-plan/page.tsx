...
const PLANES = [
  {
    ...
    nombre: 'Básico',
    precio: 399,
    descripcion: 'El primer paso para que te descubran.',
    features: [
      { icon: IconBuildingStore, text: 'Tu negocio visible en la app' },
      { icon: IconTicket, text: '2 promociones activas para atraer gente nueva' },
      { icon: IconChartBar, text: 'Tus primeros números: visitas y canjes' },
      { icon: IconHeadset, text: 'Soporte por correo' },
    ],
    noIncluye: [
      'Tendencias y crecimiento',
      'Posición destacada',
      'Creación de video mensual',
    ],
  },
  {
    ...
    precio: 799,
    popular: true,
    descripcion: 'Haz que tu negocio destaque y atrae nuevos clientes.',
    features: [
      { icon: IconTicket, text: 'Promociones ilimitadas' },
      { icon: IconBuildingStore, text: 'Creación de video mensual para tu negocio' },
      { icon: IconStarFilled, text: 'Apareces antes que la competencia' },
      { icon: IconChartBar, text: 'Ve qué funciona: tendencias y crecimiento' },
      { icon: IconHeadset, text: 'Soporte inmediato' },
    ],
    noIncluye: [
      'Conoce a tu clientela: edades, género, quién repite',
      'Pauta de Meta Ads dedicada',
      'Asesor personal de enplan',
    ],
  },
  {
    ...
    nombre: 'Premium',
    precio: 1499,
    descripcion: 'Todo el poder de enplan.',
    features: [
      { icon: IconTicket, text: 'Promociones ilimitadas con visibilidad máxima' },
      { icon: IconCrown, text: 'Pauta de Meta Ads dedicada a tu negocio' },
      { icon: IconBuildingStore, text: 'Creación de video mensual para tu negocio' },
      { icon: IconStarFilled, text: 'Posición #1 en tu categoría' },
      { icon: IconUsers, text: 'Conoce a tu clientela: edades, género, quién repite' },
      { icon: IconCrown, text: 'Tu propio asesor de enplan, siempre disponible' },
    ],
    noIncluye: [],
  },
]
