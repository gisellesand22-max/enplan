...
// Values mirror @enplan/ui/tailwind-preset so the shared components render
// consistently. Inlined here (instead of importing the preset) to keep the
// Tailwind config resolution self-contained.
const config: Config = {
  content: [
    './app/**/*.{ts,tsx}',
    './components/**/*.{ts,tsx}',
